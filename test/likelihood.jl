...
function generate_data(sol, t)
    ...
    return data = convert(Array, randomized)
end
...
@test result.original.archive_output.best_candidate ≈ [1.5, 1.0] atol = 1.0e-1
...
result = bboptimize(obj, SearchRange = [(0.5, 5.0), (0.5, 5.0)], MaxSteps = 11.0e3)
