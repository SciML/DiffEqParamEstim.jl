using BlackBoxOptim, DiffEqParamEstim, Base.Test
...
cost_function = build_loss_objective(prob2,Tsit5(),L2Loss(t,data,data_weight=1.0),
                                     maxiters=10000,verbose=false)
...
cost_function = build_loss_objective(prob3,Tsit5(),L2Loss(t,data,data_weight=0.3,differ_weight=nothing),
                                     maxiters=10000,verbose=false)
bound3 = Tuple{Float64, Float64}[(1, 2),(0, 2), (1, 4), (0, 2)]
result = bboptimize(cost_function;SearchRange = bound3, MaxSteps = 11e3)
@test result.archive_output.best_candidate ≈ [1.5;1.0;3.0;1.0] atol=5e-1

cost_function = build_loss_objective(prob3,Tsit5(),L2Loss(t,data,data_weight=nothing,differ_weight=nothing),
                                     maxiters=10000,verbose=false)
bound3 = Tuple{Float64, Float64}[(1, 2),(0, 2), (1, 4), (0, 2)]
result = bboptimize(cost_function;SearchRange = bound3, MaxSteps = 11e3)
@test result.archive_output.best_candidate ≈ [1.5;1.0;3.0;1.0] atol=5e-1

cost_function = build_loss_objective(prob3,Tsit5(),L2Loss(t,data,data_weight=0.3,differ_weight=10),
                                     maxiters=10000,verbose=false)
bound3 = Tuple{Float64, Float64}[(1, 2),(0, 2), (1, 4), (0, 2)]
result = bboptimize(cost_function;SearchRange = bound3, MaxSteps = 11e3)
@test result.archive_output.best_candidate ≈ [1.5;1.0;3.0;1.0] atol=5e-1