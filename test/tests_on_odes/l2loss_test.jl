...
cost_function = build_loss_objective(prob2,Tsit5(),L2Loss(t,data,nothing,1.0),
                                     maxiters=10000,verbose=false)
...
cost_function = build_loss_objective(prob3,Tsit5(),L2Loss(t,data,10),
                                     maxiters=10000,verbose=false)
...
cost_function = build_loss_objective(prob3,Tsit5(),L2Loss(t,data,0.3,0.7),
                                     maxiters=10000,verbose=false)
